    ...
    <script type="text/javascript">
        ...
        Ext.onReady(function () {
          ...
          Ext.define("vconfig", {
            ...
            prmaster : <?php echo json_encode($prmaster); ?>,
            prmaster_data : <?php echo json_encode($prmaster_data); ?>,
            prinvest : <?php echo json_encode($prinvest); ?>,
          ...
          Ext.application({
            ...
            autoCreateViewport: "TDK.MODEMAIL.approval_pr_invest.approval_pr_invest",
            requires: [
                "vconfig",
                "COMP.run",
                "COMP.download",
            ...
            launch: function () {
              ...
              localStorage.setItem("TDK_JWT", vconfig.token);
              localStorage.setItem("TDK_PROFILE", vconfig.profile);

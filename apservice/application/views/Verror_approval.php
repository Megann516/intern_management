...
<div id="container">
	...
	<div id="body">
		<p>Dokumen Approval sudah di proses atau sudah tidak berlaku</p>
		<p>Login Aplikasi apabila anda ingin melihat hasil Approval <a href=<?php echo $base_path; ?>>Login Application</a>.</p>
	</div>
